	...
	public void run() {
		...
		while (b) {
			...
			try {
				...
				System.out.println("Hello User " + user + "! Server is waiting for a client to connect!");
				...
				System.out.println("Hi " + user + "! The client has connected!");
				...
				dos.writeUTF("insert message here");
				// 15. Close the client server
				ss.close();
			} catch (SocketTimeoutException IOException) {
				// TODO: handle exception
				System.out.println("SocketTimeoutExpection!!");
				b = false;
			} catch (IOException e) {
				// TODO: handle exception
